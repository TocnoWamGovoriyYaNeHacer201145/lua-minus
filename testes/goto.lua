...
global<const> show, load, assert, string, setmetatable
global<const> collectgarbage, error

show("testing goto and global declarations")
...
errmsg([[ goto l1; local aa ::l1:: ::l2:: show(3) ]], "scope of 'aa'")

errmsg([[ goto l2; global *; ::l1:: ::l2:: show(3) ]], "scope of '*'")
...
do
  ...
  if not T then  -- when not in "test mode", "global" isn't reserved
    ...
    show "  ('global' is not a reserved word)"
  else
...
do  show "testing initialization in global declarations"
