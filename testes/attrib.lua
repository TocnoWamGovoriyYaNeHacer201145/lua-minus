...
show("package config: "..string.gsub(package.config, "\n", "|"))
...
do  show"testing 'require' message"
  local oldpath = package.path
...
do  show("testing external strings")
  package.cpath = DC"?"
...
show("testing assignments, logical operators, and constructors")
...
local a, b, c
a = {10,9,8,7,6,5,4,3,2; [-3]='a', [f]=show, a='a', b='ab'}
a, a.x, a.y = a, a[-3]
assert(a[1]==10 and a[-3]==a.a and a[f]==show and a.x=='a' and not a.y)
a[1], f(a)[2], b, c = {['alo']=assert}, 10, a[1], a[f], 6, 10, 23, f(a), 2
a[1].alo(a[2]==10 and b==10 and c==show)
