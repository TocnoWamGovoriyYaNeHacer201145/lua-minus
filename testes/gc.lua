...
show('testing incremental garbage collection')
...
do
  local setmetatable,assert,type,show,getmetatable =
        setmetatable,assert,type,show,getmetatable
  local tt = {}
  tt.__gc = function (o)
