...
show(string.format(
  "\tshort %d, int %d, long %d, size_t %d, float %d, double %d,\n\z
   ...
   sizeLI, sizenumber))
show("\t" .. (little and "little" or "big") .. " endian")
...
show "testing pack/unpack of floating-point numbers" 
...
show "testing pack/unpack of strings"
do
