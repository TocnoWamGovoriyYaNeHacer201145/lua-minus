...
show("testing functions and calls")
...
do   show"testing chains of '__call'"
  local N = 15
  local u = table.pack
  for i = 1, N do
...
assert(not pcall(string.dump, show))  -- no dump of C functions
