...
do
  show("testing load of binaries in fixed buffers")
  local source = {}
  local N = 1000
...
if not _soft then
  ...
  show"testing stack overflow in unprotected thread"
  function F () F() end
...
local t = {true, false, 4.56, show, {}, b, "XYZ"}
...
-- testing lua_equal
assert(T.testC("compare EQ 2 4; return 1", show, 1, show, 20))
...
-------------------------------------------------------------------------
show"testing to-be-closed variables"
