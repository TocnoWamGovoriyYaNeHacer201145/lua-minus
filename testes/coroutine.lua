...
do
  ...
  local co = coroutine.create(show)
...
do show("coroutines closing itself")
...
if not T then
  ...
  show "testing yields inside hooks"
...
show"testing yields inside metamethods"
...
show"testing yields inside 'for' iterators"
